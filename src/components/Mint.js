            ...
            <div class="col-md-6 d-flex justify-content-between flex-column">
              <div class="form publish-form">
                <div class="form-group text-input-with-label my-3">
                  ...
                  <input type="text" class="form-control" id="filename" aria-describedby="filename"
                         value={this.state.kulfy.name} placeholder="Ex. Naku English Raadu"/>
                </div>
                <div class="form-group d-flex flex-column my-3">
                  <label for="tags my-2">Add Tags</label>
                  <input type="text" class="tag-input my-1" name="tags" id="tags"
                         placeholder="Ex. Chiru, Happy, Comedy, LOL"/>
                  <div class="tags-list  my-1">
                    <span>{this.state.kulfy.category}<a href="#"><img
                      src="https://cdn.kulfyapp.com/kulfy/delete-circle-small.svg" width="8px" alt=""/></a></span>
                  </div>
                </div>
              ...
              <div class="bar-publish">
                ...
                <div class="publish-actions">
                  ...
                  <button type="submit" onClick={() => this.processKulfy()}><img
                    src="https://cdn.kulfyapp.com/kulfy/check-black.svg" alt=""/> <span>Process</span></button>
                </div>
                <div class="publish-actions">
                  <button><img src="https://cdn.kulfyapp.com/kulfy/delete-white.svg" alt=""/></button>
                  <button type="submit" onClick={() => this.mintKulfy()}><img
                    src="https://cdn.kulfyapp.com/kulfy/check-black.svg" alt=""/> <span>Mint</span></button>
                </div>
              </div>
            </div>
